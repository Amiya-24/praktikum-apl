...
int main(){
    ...
    mhs_baru.nama = "Faiz";
    mhs_baru.nim = "031";
    mhs_baru.kelas = "A2'24";
    mhs_baru.tanggal_lhr.hari = 24;
    mhs_baru.tanggal_lhr.bulan = "08";
    mhs_baru.tanggal_lhr.tahun = 2000;

    // cout << "Nama : " << mhs_baru.nama << endl;
    // cout << "Nim : " << mhs_baru.nim << endl;
    // cout << "Kelas : " << mhs_baru.kelas << endl;
    // cout << "Tanggal Lahir : " << mhs_baru.tanggal_lhr.hari << "/" << mhs_baru.tanggal_lhr.bulan << "/" << mhs_baru.tanggal_lhr.tahun << "\n" << endl;
    
    Mahasiswa mhs_abadi[5];
    mhs_abadi[0].nama = "faiz";
    mhs_abadi[1].nama = "zeydan";
    mhs_abadi[2].nama = "fathur";
    mhs_abadi[3].nama = "amin";
    mhs_abadi[4].nama = "zaky";

    for(int i = 0; i < 5; i++){
        cout << mhs_abadi[i].nama << endl;
    }
